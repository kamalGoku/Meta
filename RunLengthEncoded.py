...
Each encoded[i] = [val_i, freq_i] describes the i-th segment of repeated numbers in nums
where val_i is the value that is repeated freq_i times.
...
Both nums1 and nums2 have the same length. Each encoded1[i] = [val_i, freq_i] describes the i-th segment of nums1,
...
def productEncodedArrays(encoded1, encoded2):
    res = []
    i=0
    j=0
...
encoded2 = [[2,3],[3,3]]
print(productEncodedArrays(encoded1, encoded2))
